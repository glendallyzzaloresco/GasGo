...
<style>
    ...
    @keyframes stepPulse {
        ...
        50% { box-shadow: 0 8px 30px rgba(247, 148, 29, 0.2); }
    }
    @keyframes iconFloat {
    ...
    @keyframes connectorFlow {
        0% { background: linear-gradient(90deg, var(--gasgo-orange), transparent); }
        50% { background: linear-gradient(90deg, transparent, var(--gasgo-orange)); }
        100% { background: linear-gradient(90deg, var(--gasgo-orange), transparent); }
    }
...
<div class="container section-padding">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="voucher-card" style="background: linear-gradient(135deg, rgba(247, 148, 29, 0.08) 0%, rgba(15, 52, 96, 0.05) 100%); border: 2px solid var(--gasgo-orange); border-radius: 16px; padding: 20px; box-shadow: 0 4px 15px rgba(247, 148, 29, 0.1); transition: all 0.3s ease;">
                    ...
                    <div style="background: white; padding: 12px; border-radius: 12px; margin-bottom: 12px; border-left: 4px solid var(--gasgo-orange);">
                        <div style="font-size: 1.5rem; font-weight: 700; color: var(--gasgo-orange);">₱{{ number_format($voucher->discount_amount, 2) }}</div>
    ...
    <div class="my-5">
        <div data-aos="fade-up" class="mb-4">
            <h2 class="section-title">
                <i class="fas fa-ladder me-2" style="color: var(--gasgo-orange);"></i>How Loyalty Works
            </h2>
        ...
        <div class="rewards-preview">
            ...
            <div class="reward-item" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                ...
                <div style="margin-bottom: 12px;">
                    <span style="display: inline-block; padding: 4px 12px; background: linear-gradient(135deg, var(--gasgo-orange), #ff6b35); color: white; border-radius: 20px; font-size: 0.7rem; font-weight: 700; text-transform: uppercase;">
                        {{ $reward['tier'] }}
                    </span>
                </div>
                <h6>{{ $reward['title'] }}</h6>
    ...
    <div class="my-5">
        <div data-aos="fade-up" class="mb-4">
            <h2 class="section-title">
                <i class="fas fa-question-circle me-2" style="color: var(--gasgo-orange);"></i>Frequently Asked Questions
            </h2>
    ...
    <div class="text-center mt-5 mb-3" data-aos="fade-up">
        ...
        <a href="{{ url('/customer/product') }}" class="btn" style="background: var(--gasgo-orange); color: white; padding: 12px 40px; border-radius: 25px; font-weight: 600; display: inline-block;">
