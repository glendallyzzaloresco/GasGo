...
<head>
    ...
    <title>{{ trim($settings->brand_name_primary . ' ' . $settings->brand_name_accent) }} Rider | @yield('title', 'Dashboard')</title>
    ...
    <script>
        window.gasgoConfirm = function(options = {}) {
            ...
            const isDelete = Boolean(
                options.isDelete ||
                options.isDanger ||
                (typeof options.text === 'string' && (options.text.toLowerCase().includes('delete') || options.text.toLowerCase().includes('cancel'))) ||
                (typeof options.title === 'string' && (options.title.toLowerCase().includes('delete') || options.title.toLowerCase().includes('cancel')))
            );
        ...
        window.confirmLogout = async function(formId = 'logout-form') {
            const confirmed = await window.gasgoConfirm({
                title: 'Log Out',
                text: 'Are you sure you want to log out of your rider account?',
