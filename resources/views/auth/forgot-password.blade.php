...
@section('title', 'Forgot Password - GasGo')
...
<style>
    ...
    .back-to-login {
        ...
        margin-top: 20px; width: 100%; transition: color .2s;
    }
    .back-to-login:hover {
        ...
        <div class="auth-form">
            ...
            <form action="{{ route('password.email') }}" method="POST">
                ...
                <div class="form-floating-gasgo">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="you@email.com" class="@error('email') is-invalid @enderror" autocomplete="email" required autofocus>
                    @error('email')
                ...
                <button type="submit" class="btn-auth">
                    <i class="fas fa-paper-plane me-2"></i>Send 6-Digit Code
                </button>
            </form>
